...
- GitHub Copilot は、まず `AGENTS.md` の共通方針に従う。
- ファイル種別・技術領域ごとの詳細指示がある場合は、`.github/instructions/` 配下の `*.instructions.md` を参照する。
- このファイルには、Copilot固有の運用方針だけを書く。
- Cursor向けの `.cursor/rules/project.mdc` と、補足内容が大きくズレないようにする。
